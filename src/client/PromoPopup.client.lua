...
local passes = {
	{key = "DoubleIncome", label = "2x TIPS", color = Color3.fromRGB(50, 200, 50), desc = "Double all tips forever!"},
	{key = "AutoCollect", label = "AUTO-BUILD", color = Color3.fromRGB(50, 150, 255), desc = "Auto-build stations!"},
	{key = "VIP", label = "VIP CHEF", color = Color3.fromRGB(255, 100, 100), desc = "3 exclusive VIP stations!"},
	{key = "SpeedBoost", label = "SPEED BOOST", color = Color3.fromRGB(50, 200, 150), desc = "Move 1.5x faster!"},
}
