...
local function createLobby()
	...
	base.Anchored = true
	base.Color = Color3.fromRGB(180, 140, 100)
	...
	titleLabel.Text = "FOOD FACTORY TYCOON"
	...
	subtitleLabel.Text = "Build Your Food Factory Empire!"
...
local function createPlot(plotNum)
	...
	for _, treePos in ipairs({
		...
		canopy.Color = Color3.fromRGB(60, 120, 40)
